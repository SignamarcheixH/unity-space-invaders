...
public class EnemyLaser : MonoBehaviour {
    ...
    readonly float projectileSpeed = 12f;
    public float x;
    public float speed;
    ...
    public void HS_Fire() {
        ...
        if(randomness >= 990) {
            GameObject bullet = Instantiate(projectile, new Vector3(transform.position.x, transform.position.y - 3 , transform.position.z), transform.rotation);
